...
const UserUpdate =() => {
  ...
  const handleUserUpdate= async (event) => {
    ...
    const response = await fetch('http://3.37.122.192:8000/api/account/update-account', { 
        method: "PATCH",
        headers: {
            "Content-Type": "application/json",
             Authorization: `Bearer ${token}`
        ...
        <Header />
            ...
            <div className="user-update-inner">
                ...
                <div className="user-update-form-group">
                    <div className="address">
                        ...
                        <div className="address-detail">
                            <input value={roadAddress} readOnly className="user-update-input"/>
                            <input
                                type="text"
                                value={detailAddress}
                                className="user-update-input"
                ...
                <div className="user-update-btn">
                    ...
                    <button className="user-update-btn-ok" onClick={handleUserUpdate} >수정</button>
                </div>
